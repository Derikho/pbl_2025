...
<nav class="navbar navbar-expand-lg navbar-admin sticky-top">
    <div class="container-fluid">
        ...
        <div class="navbar-actions ms-auto">
            ...
            <a href="logout.php" class="btn btn-sm btn-outline-light"><i class="fas fa-sign-out-alt me-1"></i>Logout</a>
        </div>
    </div>
</nav>
...
<div class="admin-container">
    <div class="admin-sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="menu-item active"><a href="admin_absent.php"><i class="fas fa-clipboard-list me-2"></i><span>Absent</span></a></li>
    ...
    <div class="admin-content">
        <div class="content-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <?php if(!$show_form): ?>
                    <a href="admin_absent.php?action=add" class="btn btn-primary"><i class="fas fa-plus me-1"></i> Add Attendance</a>
                <?php else: ?>
                    <a href="admin_absent.php" class="btn btn-secondary"><i class="fas fa-arrow-left me-1"></i> Back to List</a>
                <?php endif; ?>
            </div>
        </div>
            ...
            <div class="row mb-4">
                <div class="col-md-3 mb-3">
                    <div class="stats-card bg-white p-3 rounded shadow-sm border-start border-primary border-4">
                        <h3 class="mb-0 fw-bold"><?php echo $stats['total']; ?></h3><p class="text-muted mb-0 small">Total Hari Ini</p>
                    </div>
                </div>
                <div class="col-md-3 mb-3">
                    <div class="stats-card bg-white p-3 rounded shadow-sm border-start border-success border-4">
                        <h3 class="mb-0 fw-bold"><?php echo $stats['tepat_waktu']; ?></h3><p class="text-muted mb-0 small">Tepat Waktu</p>
                    </div>
                </div>
                <div class="col-md-3 mb-3">
                    <div class="stats-card bg-white p-3 rounded shadow-sm border-start border-warning border-4">
                        <h3 class="mb-0 fw-bold"><?php echo $stats['terlambat']; ?></h3><p class="text-muted mb-0 small">Terlambat</p>
                    </div>
                </div>
                <div class="col-md-3 mb-3">
                    <div class="stats-card bg-white p-3 rounded shadow-sm border-start border-info border-4">
                        <h3 class="mb-0 fw-bold"><?php echo $stats['sudah_keluar']; ?></h3><p class="text-muted mb-0 small">Sudah Pulang</p>
                    </div>
                </div>
            </div>
        <?php endif; ?>
                    ...
                    <form method="POST" action="admin_absent.php" enctype="multipart/form-data">
                        ...
                        <div class="d-flex gap-2 mt-4">
                            <button type="submit" name="<?php echo $edit_mode ? 'update_attendance' : 'add_attendance'; ?>" 
                                ...
                                <i class="fas fa-save me-1"></i> <?php echo $edit_mode ? 'Update Record' : 'Save Record'; ?>
                            </button>
                            <a href="admin_absent.php" class="btn btn-secondary px-4"><i class="fas fa-times me-1"></i> Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
                            ...
                            <tbody>
                                <?php if($attendance_logs->rowCount() > 0): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><small><?php echo date('M j, Y', strtotime($log['date'])); ?></small></td>
                                        <td>
                                        ...
                                        <td class="text-end">
                                            <div class="btn-group">
                                                ...
                                                <a href="admin_absent.php?delete_id=<?php echo $log['id']; ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Delete this record?')"><i class="fas fa-trash"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php endwhile; ?>
                                <?php else: ?>
                                    <tr><td colspan="9" class="text-center py-5 text-muted">No Attendance Records Yet</td></tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    </div>
